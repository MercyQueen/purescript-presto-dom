...
function parsePropsImpl(elem, screenName, VALIDATE_ID, namespace) {
  ...
  return {dom : { type : type, machine : elem.machine, screen : elem.screen, props:props, children:elem.children, parentType : elem.parentType, __ref : elem.__ref}, ids : VALIDATE_ID}
}
